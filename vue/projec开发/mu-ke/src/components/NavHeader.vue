<template>
  <header class="header">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <div class="navbar-cart-container">
            ...
            <a class="navbar-link navbar-cart-link" href="javascript:;" @click="goCart">
    ...
    <modal v-bind:mdShow="isMdShow" v-on:close="mdClose">
      <p slot="message">请先登录,否则无法查看购物车中商品！</p>
      <div slot="btnGroup"> 
        <a class="btn btn--m" href="javascript:;" @click="loginModalFlag=true,isMdShow=false">登陆</a>
...
export default {
  data() {
    return {
      ...
      errorTip: false,
      isMdShow:false,
      loginModalFlag: false //登陆成功把遮罩层关掉
    };
  },
  components:{
    Modal
